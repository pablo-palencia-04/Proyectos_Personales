...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        setResizable(false);//fijar el tamaño
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(322, 128));
        ...
        if (txtUsuario.getText().trim().isEmpty() || txtContraseña.getText().trim().isEmpty()) {
            ...
            try {
                ...
                if (contrasenaCifradaIngresada != null &&
                    ...
                    UsuarioConectado.setIdUsuario(usuarioAConsultar.getId_usuario());
                    UsuarioConectado.setUserName(usuarioAConsultar.getUsername());
                    
                    JOptionPane.showMessageDialog(null, "Bienvenido al SISTEMA,\n Usuario: " + usuarioAConsultar.getUsername(), "Mensaje de bienvenida", JOptionPane.INFORMATION_MESSAGE);
